...
<img src="https://i.postimg.cc/hj3VsxHm/1.png" height="60%" width="60%" alt="Steps"/>
<br />
<br />
...
<img src="https://i.postimg.cc/PqSDfYf7/2.png" height="60%" width="60%" alt="Steps"/>
<img src="https://i.postimg.cc/0ydm3hTP/3.png" height="60%" width="60%" alt="Steps"/>
<br />
<br />
Step 4: Configure the virtual machine by giving it two network adapters: one for connecting to the internet and the other for the internal network.
 <br/>
<img src="https://i.postimg.cc/3w8pHnhp/4.png" height="60%" width="60%" alt="Steps"/>
<img src="https://i.postimg.cc/HsMb0r3J/5.png" height="60%" width="60%" alt="Steps"/>
<br />
<br />
...
<img src="https://i.postimg.cc/zG1KxqPx/7.png" height="60%" width="60%" alt="Steps"/>
<br />
<br />
...
<img src="https://i.postimg.cc/prhz6rH6/8.png" height="60%" width="60%" alt="Steps"/>
<br />
<br />
...
<img src="https://i.postimg.cc/h4697L8W/9.png" height="60%" width="60%" alt="Steps"/>
<img src="https://i.postimg.cc/1tTNwSqc/10.png" height="60%" width="60%" alt="Steps"/>
<br/>
<br/>
Step 5: Rename the PC to DC for convenience. Click on System<br/>
<img src="https://i.postimg.cc/cH6nvCrL/11.png" height="40%" width="40%" alt="Steps"/>
<img src="https://i.postimg.cc/ZndvLQPk/12.png" height="60%" width="60%" alt="Steps"/>
<br />
<br />
...
<br/>
<img src="https://i.postimg.cc/K4hkp5Q1/13.png" height="60%" width="60%" alt="Steps"/>
<br />
<br />
Step 2: Click "Add roles and features"<br/>
<img src="https://i.postimg.cc/h4fw9RwJ/14.png" height="60%" width="60%" alt="Steps"/>
<br />
<br />
Step 3: This is the first screen, and you must click Next to proceed<br/>
<img src="https://i.postimg.cc/VsphgHQK/15.png" height="60%" width="60%" alt="Steps"/>
<br />
<br />
Step 4: Click Next until this window where you must install the AD comes up<br/>
Now, Add features > next > next > next > install <br />
<img src="https://i.postimg.cc/13Zjhnz6/17.png" height="60%" width="60%" alt="Steps"/>
<img src="https://i.postimg.cc/N0sCF3mj/18.png" height="60%" width="60%" alt="Steps"/>
<img src="https://i.postimg.cc/YSdnWdzf/19.png" height="60%" width="60%" alt="Steps"/> <br/><br />
Done, close
<br/>
<br/>
Step 5: Click on the exclamation mark at the top and then "Promote this server to a domain controller" <br/>
<img src="https://i.postimg.cc/wjcb6qtr/20.png" height="40%" width="40%" alt="Steps"/>
<img src="https://i.postimg.cc/sX1n95nF/21.png" height="60%" width="60%" alt="Steps"/>
<img src="https://i.postimg.cc/pT7s0y7m/22.png" height="60%" width="60%" alt="Steps"/>
<img src="https://i.postimg.cc/x8ztBnDt/23.png" height="60%" width="60%" alt="Steps"/><br/><br/>
Next > Next > Install<br/>
<img src="https://i.postimg.cc/Df9CLJLD/24.png" height="60%" width="80%" alt="Steps"/><br/><br/>
At the end of the installation, you will automatically be signed out
<img src="https://i.postimg.cc/2jbc1Fbh/25.png" height="60%" width="60%" alt="Steps"/><br/><br />
Now, mydomain/admin is visible when attempting to login
<img src="https://i.postimg.cc/R0pdFNvg/26.png" height="60%" width="60%" alt="Steps"/>
<br/>
<br/>
<br/>
...
<img src="https://i.postimg.cc/JzqKfpvV/27.png" height="60%" width="60%" alt="Steps"/><br /><br />
...
<img src="https://i.postimg.cc/g2dNtCMH/28.png" height="60%" width="60%" alt="Steps"/>
<img src="https://i.postimg.cc/Fs0TZrxK/29.png" height="60%" width="60%" alt="Steps"/><br/><br/>
Step 3: We are creating a new user now, which will be an administrator.
<img src="https://i.postimg.cc/43xwszRK/30.png" height="60%" width="60%" alt="Steps"/>
<img src="https://i.postimg.cc/jd4QRD0x/31.png" height="60%" width="60%" alt="Steps"/><br /><br />
Next <br/>
<img src="https://i.postimg.cc/rwh1t7w7/32.png" height="60%" width="60%" alt="Steps"/><br/>
Next > Finish <br/><br/>
Step 4: Now, after this user was created, we are going to make it an administrator.
<img src="https://i.postimg.cc/g0nvy4wj/33.png" height="60%" width="60%" alt="Steps"/><br /><br />
Ok > Apply > Ok <br />
<img src="https://i.postimg.cc/rsLxkkfR/34.png" height="60%" width="60%" alt="Steps"/>
<img src="https://i.postimg.cc/W3ZgC3wP/35.png" height="60%" width="60%" alt="Steps"/>
<br/><br/>
After this is done, Sign out of the account and sign in as the user just created.<br />
<img src="https://i.postimg.cc/VvBMsVhG/36.png" height="60%" width="60%" alt="Steps"/><br/><br/>
<h3><b>Installing RAS/NAT</b></h3><br/><br/><br/>
Step 1: Open Server Manager and click on "Add Roles and Features"<br/>
<img src="https://i.postimg.cc/tg9JXGq4/37.png" height="60%" width="60%" alt="Steps"/><br/><br/>
Next > next > Remote access<br/>
<img src="https://i.postimg.cc/CdyMXWrY/38.png" height="60%" width="60%" alt="Steps"/><br/><br/>
Next > next > next > Routing > Addfeatures<br/>
<img src="https://i.postimg.cc/g04Jjtjq/39.png" height="60%" width="60%" alt="Steps"/><br/><br/>
Next> next > next > Install<br/>
<img src="https://i.postimg.cc/PxR5zLmC/40.png" height="60%" width="60%" alt="Steps"/><br/><br/>
...
<img src="https://i.postimg.cc/C11KqCfy/42.png" height="60%" width="60%" alt="Steps"/>
<img src="https://i.postimg.cc/c1PQdCV1/43.png" height="60%" width="60%" alt="Steps"/><br/><br/>
Select "Network Address Translation (NAT) and then click Next"<br/>
<img src="https://i.postimg.cc/zDyCmK2P/44.png" height="60%" width="60%" alt="Steps"/><br/>
<img src="https://i.postimg.cc/qq6MmkLj/45.png" height="60%" width="60%" alt="Steps"/><br/><br/>
...
<img src="https://i.postimg.cc/ht3vX8kk/46.png" height="60%" width="60%" alt="Steps"/><br/><br/>
Click on DHCP Server > Add Features > Next > Next > Next > Install<br/>
<img src="https://i.postimg.cc/k505cJXw/47.png" height="60%" width="60%" alt="Steps"/><br/>
<img src="https://i.postimg.cc/fyZTG8d9/48.png" height="60%" width="60%" alt="Steps"/><br /><br />
...
<img src="https://i.postimg.cc/sX5gHkMz/50.png" height="60%" width="60%" alt="Steps"/><br /><br />
Step 4: Follow the image and make the changes exactly as described in them<br/>
<img src="https://i.postimg.cc/25b6hbmV/51.png" height="60%" width="60%" alt="Steps"/>
<img src="https://i.postimg.cc/4y5NspvF/52.png" height="60%" width="60%" alt="Steps"/><br/><br/>
...
<img src="https://i.postimg.cc/02kyZHPg/53.png" height="60%" width="60%" alt="Steps"/><br/>
<img src="https://i.postimg.cc/ZKwKQF5W/54.png" height="60%" width="60%" alt="Steps"/><br/><br/>
Here, do not forget to Add the IP address after you've entered it. <br/>
<img src="https://i.postimg.cc/P5NrnpC2/55.png" height="60%" width="60%" alt="Steps"/><br/><br/>
Next > Next > Next > Finish<br />
<img src="https://i.postimg.cc/K8dzZwgj/56.png" height="60%" width="60%" alt="Steps"/><br/><br/>
Step 5: Right click DHCP Server > Authorize
<img src="https://i.postimg.cc/MK0NZr35/58.png" height="60%" width="60%" alt="Steps"/><br/><br/>
...
<img src="https://i.postimg.cc/jjL6DLcc/57.png" height="60%" width="60%" alt="Steps"/><br/><br/>
O/p after ececution of script<br/>
<img src="https://i.postimg.cc/JhNXDZJb/59.png" height="60%" width="60%" alt="Steps"/><br/><br/><br/>
...
<img src="https://i.postimg.cc/HsRDjPQ7/61.png" height="60%" width="60%" alt="Steps"/><br/>
<img src="https://i.postimg.cc/PfVjZqmc/60.png" height="60%" width="60%" alt="Steps"/><br/><br/><br/>
...
<img src="https://i.postimg.cc/JnxgcpSm/62.png" height="60%" width="60%" alt="Steps"/><br/><br/>
The picture below explains how CLIENT1 connects to the internet.<br/>
<img src="https://i.postimg.cc/QM25YsGJ/63.png" height="60%" width="60%" alt="Steps"/><br/><br/>
...
<img src="https://i.postimg.cc/QxYqg2t0/64.png" height="60%" width="60%" alt="Steps"/><br/><br/>
...
<img src="https://i.postimg.cc/7Zpd9G6s/65.png" height="60%" width="60%" alt="Steps"/><br/><br/>
